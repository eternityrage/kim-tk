"""
Upload videos to VK (VKontakte) - KimTok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "KimTok Lens - Kim Kardashian Moments!\n\n#kimkardashian #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'KimTok Lens Video',
